 ...
 * 系统操作记录表
 */
public class SystemoperationDTO extends BaseModel {
    ...
    public SystemoperationDTO(Integer adminId, String content, String contenttype, String operationtype, Date soReleasetime) {
