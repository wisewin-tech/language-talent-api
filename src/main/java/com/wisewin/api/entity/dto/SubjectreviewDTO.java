 ...
 * 做题记录类(复习)
 */
public class SubjectreviewDTO extends BaseModel {
    ...
    public SubjectreviewDTO(){}

    public SubjectreviewDTO(Integer userId, Date srReleasetime, Integer hourId, Integer questionbankId, String answer, String judge) {
        this.userId = userId;
